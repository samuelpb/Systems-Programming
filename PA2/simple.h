/*HEADER FILE FOR THE SIMPLE.C, THE CODE FROM PA0*/
...
/*function to create the output file name for the sorted file*/

char * createOutputName (char * outputDir, char * filename, char * key) {
